...
namespace RM.Hotel {
    ...
    [Ignore]
    public class StoreServiceClient : MagicOnionClientBase<global::RM.Hotel.IStoreService>, global::RM.Hotel.IStoreService
    {
        static readonly Method<byte[], byte[]> SendEventMethod;
        static readonly Func<RequestContext, ResponseContext> SendEventDelegate;

        static StoreServiceClient()
        {
            SendEventMethod = new Method<byte[], byte[]>(MethodType.Unary, "IStoreService", "SendEvent", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);
        ...
        public StoreServiceClient(CallInvoker callInvoker, IFormatterResolver resolver, IClientFilter[] filters)
        ...
        {
            var clone = new StoreServiceClient();
        ...
        static ResponseContext _SendEvent(RequestContext __context)
        {
            return CreateResponseContext<global::RM.Hotel.ActionEvent, global::RM.Hotel.EventResult>(__context, SendEventMethod);
        }

        public global::MagicOnion.UnaryResult<global::RM.Hotel.EventResult> SendEvent(global::RM.Hotel.ActionEvent t)
        {
            return InvokeAsync<global::RM.Hotel.ActionEvent, global::RM.Hotel.EventResult>("IStoreService/SendEvent", t, SendEventDelegate);
        }
    }
}
